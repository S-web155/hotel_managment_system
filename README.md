...
1. Download the latest `hotel_manager.exe` from [GitHub Releases](https://github.com/yourusername/hotel-management-system/releases)
...
- [GitHub Repository](https://github.com/yourusername/hotel-management-system)
- [Releases](https://github.com/yourusername/hotel-management-system/releases)
